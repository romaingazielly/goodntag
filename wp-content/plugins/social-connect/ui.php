		...
		<div class="social_connect_ui <?php if( strpos( $_SERVER['REQUEST_URI'], 'wp-signup.php' ) ) echo 'mu_signup'; ?>">
			...
			<?php do_action ('social_connect_pre_form'); ?>
				<?php if( $facebook_enabled ) :
					echo apply_filters('social_connect_login_facebook','<a href="javascript:void(0);" title="Facebook" class="st-icon-facebook">Facebook</a>');
				endif; ?>
				<?php if( $twitter_enabled ) :
					echo apply_filters('social_connect_login_twitter','<a href="javascript:void(0);" title="Twitter" class="st-icon-twitter">Twitter</a>');
				endif; ?>
				<?php if( $google_enabled ) :
					echo apply_filters('social_connect_login_google','<a href="javascript:void(0);" title="Google" class="st-icon-google">Google</a>');
				endif; ?>
