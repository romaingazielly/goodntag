...
if ( function_exists( 'add_image_size' ) ) { 
    ...
    add_image_size( 'brand_slider', 9999, 300, true ); //(cropped)
    add_image_size( 'brand_product', 9999, 170, true ); //(cropped)
    add_image_size( 'brand_rubrique', 306, 125, true ); //(cropped)
}
add_filter( 'image_size_names_choose', 'brand_slider' );
add_filter( 'image_size_names_choose', 'brand_product' );
add_filter( 'image_size_names_choose', 'brand_rubrique' );

function brandSlider( $sizes ) {
    return array_merge( $sizes, array(
        'brand_slider' => __('Carrousel marque'),
    ) );
}
function brandProduct( $sizes ) {
    return array_merge( $sizes, array(
        'brand_product' => __('Marque dernier produit'),
    ) );
}
function brandRubrique( $sizes ) {
    return array_merge( $sizes, array(
